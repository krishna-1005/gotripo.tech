...
export function Chatbot() {
  ...
  const greeting: Message = {
    role: "assistant",
    content: `Namaste${user?.displayName ? `, ${user.displayName.split(' ')[0]}` : ''}! I'm your GoTripo AI Assistant. Ready to explore the vibrant colors of India? Tell me where you want to go or what kind of vibe you're looking for!`
  };
    ...
    <div 
      ...
      <div className="p-5 flex items-center justify-between border-b border-border bg-secondary/50 backdrop-blur-xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-display font-bold text-foreground leading-none">GoTripo AI</div>
