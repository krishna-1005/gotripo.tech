...
export default function YatraListPage() {
  ...
  return (
    <div className="font-['Poppins'] bg-[#FFFDF7] dark:bg-[#0B0B0B] text-slate-900 dark:text-white selection:bg-[#FF6B00] selection:text-white transition-colors duration-500 relative min-h-screen overflow-hidden">
      <MarketingNav />
